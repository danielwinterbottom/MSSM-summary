...
TCanvas* squared_legend_to_right(float lower_x=130., float upper_x=2100., float lower_y=1., float upper_y=60., int log_x=1, int log_y=1, bool preliminary=true, bool inc_partial_lum=true, bool supplementary=false){
