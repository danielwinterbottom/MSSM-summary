...
parser.add_argument('--br', type=str, help='Decay mode (WW, ZZ, hh)')
...
if args.decay == 'hh':
    ...
    if args.br =="bbbb":
        limits_file = "json_channels/Htobbbb.json"
    if args.br =="bbbb_boosted":
        limits_file = "json_channels/Htobbbb_boosted.json"
    if args.br =="bbgg":
        limits_file = "json_channels/Htobbgg.json"
    if args.br =="bbtt":
        limits_file = "json_channels/Htobbtt.json"
    if args.br =="bbww":
        limits_file = "json_channels/Htobbww.json"
    if args.br =="bbzz":
        limits_file = "json_channels/Htobbzz.json"
    if args.br =="multilepton":
        limits_file = "json_channels/Htomultilepton.json"
...
fout = ROOT.TFile(f'{benchmark_name}_{args.proc}ToHTo{args.decay}_{args.br}_mHsina_contours.root', 'recreate')
